...
class TrainingReports(PageBase):
    ...
    def edit_venue(self, venue):
        self.page_manager.open_page(AddVenueWizard, venue)

    def edit_training_report(self, report):
        self.page_manager.open_page(AddTrainingReportWizard, report)
    ...
    def add_venue_button_pressed(self):
        self.page_manager.open_page(AddVenueWizard)

    def add_training_button_pressed(self):
        self.page_manager.open_page(AddTrainingReportWizard)
